...
#declared params outside the self.opt.get_updates()
            params=[self.pattern_tanh_tensor, self.mask_tanh_tensor] 
#declared loss outside the self.opt.get_updates()
            loss=self.loss
            self.updates = self.opt.get_updates(params,loss)
#received assertion error and put a try catch loop to handle it
        except AssertionError:
            pass
#declared updates outside K.function
